...
const Education = () => {
  return (
    <div>
        ...
        Beginning with an HTML book in the 2000's I have never quit the discipline of learning. My passion for software engineering grew from a basic HTML coding to a complex JavaScript development. Starting with PHP as my first backend environment it grew into Ruby on Rails. After that React and Node has taken a huge part of my interest and my primary to go tools. Today I am a JavaScript developer. 
        <br/>
        <div className='company-background'>@Davinci Coders</div><br/>
        Attended and received a Ruby on Rails certification.
        <br/>
